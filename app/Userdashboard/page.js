...
const UserDashboard = () => {
    ...
    return (
        ...
        //             <h1 className="ml-4 text-xl">Welcome {user.username}!</h1>
        //         </div>
        ...
        //                                 <th className="p-2 border-r border-gray-300">Order Number</th>
        //                                 <th className="p-2 border-r border-gray-300">Date of Arrival</th>
        ...
        //                                 <td className="p-2 border-r border-gray-300">228-3844-931-7689</td>
        //                                 <td className="p-2 border-r border-gray-300">Nov 20, 2022</td>
        //                                 <td className="p-2 border-r border-gray-300" style={{ color: "green", fontWeight: "500" }} >Delivered</td>
        //                                 <td className="p-2 border-r border-gray-300">Rs. 750</td>
        //                             </tr>
        //                             <tr>
        //                                 <td className="p-2 border-r border-gray-300">2</td>
        //                                 <td className="p-2 border-r border-gray-300">661-7963-661-7963</td>
        //                                 <td className="p-2 border-r border-gray-300">Aug 05, 2022</td>
        //                                 <td className="p-2 border-r border-gray-300" style={{ color: "red", fontWeight: "500" }}>Returned</td>
        //                                 <td className="p-2 border-r border-gray-300">Rs. 750</td>
        //                             </tr>
        //                             <tr>
        //                                 <td className="p-2 border-r border-gray-300">3</td>
        //                                 <td className="p-2 border-r border-gray-300">958-4030-182-0187</td>
        //                                 <td className="p-2 border-r border-gray-300">Jun 23, 2022</td>
        //                                 <td className="p-2 border-r border-gray-300" style={{ color: "green", fontWeight: "500" }}>Delivered</td>
        //                                 <td className="p-2 border-r border-gray-300">Rs. 750</td>
        //                             </tr>
        //                         </tbody>
        ...
        <div className=" bg-gray-100">
            <div className="relative">
                <div className="flex items-center justify-between mt-8 mb-4 px-7">
                    ...
                    <div className="absolute right-7 top-15 cursor-pointer" onClick={toggleDropdown}>
                        <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
                            <span className="text-white">{user.username}</span> {/* Display initial */}
                        </div>
                    </div>
                    {dropdownOpen && (
            ...
            <main className="w-full max-w-full p-4 flex flex-col  space-y-8">
                ...
                <div className="flex flex-col md:flex-row w-full justify-between space-y-4 md:space-y-0">
                    ...
                    <div className="w-full md:w-1/2 p-4 border border-gray-300 flex items-center justify-center">
                        <div className="w-full h-64 bg-gray-200 flex items-center justify-center">
                            <span>Map (integrate with actual map API)</span>
                        </div>
                    </div>
                        ...
                        {idEnter ?
                            ...
                            <div className="p-6 bg-white rounded-lg shadow-md">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="mb-2">
                                        <label className="block text-sm font-medium mb-1">Delayed by:</label>
                                        <p className="text-gray-800">1 day</p>
                                    </div>

                                    <div className="mb-2">
                                        <label className="block text-sm font-medium mb-1">Reason of Delay:</label>
                                ...
                                <div className="flex space-x-4">
                                    <button className="px-4 py-2 bg-gray-500 text-white rounded">Cancel Order</button>
                                    <button className="px-4 py-2 bg-red-500 text-white rounded">Download Invoice</button>
                                </div>
                            </div>
                            : <>
                                <div className="mb-4 w-full">
                                    <label className="block mb-2">Tracking ID:</label>
                                    <div className="flex">
                                        <input type="text" className="flex-grow p-2 border border-gray-300 rounded-l" value={trackingId} onChange={handleInputChange} />
                                        <button className="p-2 bg-blue-500 text-white rounded-r" onClick={handleConsignment}>Enter</button>
                                    </div>
                                </div>
